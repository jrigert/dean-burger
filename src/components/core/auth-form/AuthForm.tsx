...
export const AuthForm: FunctionComponent<PropsWithChildren<AuthFormProps>> = (
  ...
  return (
    <Container className="flex h-screen justify-center bg-card pt-24 sm:min-h-screen sm:items-center sm:bg-transparent sm:pt-8">
      <div className="w-full sm:w-auto sm:min-w-[500px] sm:rounded-xl sm:bg-card sm:p-12">
